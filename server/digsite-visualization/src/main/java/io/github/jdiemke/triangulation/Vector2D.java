...
public class Vector2D {
    ...
    // Added id for procedural meshes in Unreal -Selina Andrews
    public int id;
    ...
    /**
     * Constructor of the 2D vector class used to create new vector instances with a vector id.
     *
     * @param id
     *            The identifier of the new vector
     * @param x
     *            The x coordinate of the new vector
     * @param y
     *            The y coordinate of the new vector
     */
    public Vector2D(int id, double x, double y) {
        this.id = id;
        this.x = x;
        this.y = y;
    }
